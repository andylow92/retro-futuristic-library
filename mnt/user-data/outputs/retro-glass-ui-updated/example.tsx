...
export default function RetroGlassDemo() {
  return (
    <GlassContainer background="gradient" maxWidth="xl" centered>
      ...
      >
        <GlassCard title="Performance" subtitle="Lightning fast" theme="pink" neonBorder hover dots>
          <p style={{ color: 'rgba(255,255,255,0.7)' }}>
            Built with performance in mind. Tree-shakeable and optimized for production.
          </p>
          <GlassBadge theme="pink" size="sm">
            Fast
          </GlassBadge>
        </GlassCard>
        ...
        >
          ...
          <GlassBadge theme="purple" size="sm">
            Flexible
          </GlassBadge>
        </GlassCard>
      </div>
      ...
      >
        <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
          <GlassInput placeholder="Your Name" theme="pink" fullWidth />
          <GlassInput type="email" placeholder="Email Address" theme="cyan" fullWidth />
          <GlassInput placeholder="Subject" theme="purple" fullWidth />
      ...
      >
        <div style={{ display: 'flex', flexWrap: 'wrap', gap: '12px', alignItems: 'center' }}>
          ...
          <GlassBadge theme="orange" size="md">
            Featured
          </GlassBadge>
          <GlassBadge theme="cyan" size="lg">
            Premium
          </GlassBadge>
          <GlassBadge theme="purple" pulse>
            Live
          </GlassBadge>
          <GlassBadge theme="gradient" size="md">
            Popular
          </GlassBadge>
        </div>
      </GlassCard>
      ...
      >
        {[
          ...
          <GlassButton key={btn.text} theme={btn.theme} variant="neon" glowEffect dots fullWidth>
            {btn.text}
          </GlassButton>
        ))}
      </div>
      ...
      <GlassPanel variant="light" bordered={false}>
        <div style={{ textAlign: 'center', padding: '20px' }}>
          ...
          <div
            style={{ marginTop: '16px', display: 'flex', gap: '12px', justifyContent: 'center' }}
          >
            <GlassBadge variant="light" theme="cyan">
              React
            </GlassBadge>
            <GlassBadge variant="light" theme="purple">
              TypeScript
            </GlassBadge>
            <GlassBadge variant="light" theme="pink">
              Glassmorphism
            </GlassBadge>
          </div>
        </div>
